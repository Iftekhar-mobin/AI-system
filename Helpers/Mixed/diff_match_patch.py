...
dmp_module = diff_match_patch()
diff = dmp_module.diff_main("Hello.", "Good morning Hello")
print(diff)
# Result: [(-1, "Hell"), (1, "G"), (0, "o"), (1, "odbye"), (0, " World.")]
dmp_module.diff_cleanupSemantic(diff)
# Result: [(-1, "Hello"), (1, "Goodbye"), (0, " World.")]
print(diff)

dmp_module.diff_cleanupEfficiency(diff)
# Result: [(-1, "Hello"), (1, "Goodbye"), (0, " World.")]
print(diff)